!(function (t) {
  ...
  (t.cleanData = (function (e) {
    ...
    (t.widget.extend = function (e) {
      for (var i, s, n = u.call(arguments, 1), o = 0, a = n.length; o < a; o++)
        for (i in n[o])
          (s = n[o][i]),
            ...
            "right" === n.my[0]
              ...
              n.using &&
                (l = function (t) {
                  ...
                  m < c && r(e + i) < m && (h.horizontal = "center"),
                    g < d && r(s + o) < g && (h.vertical = "middle"),
                    a(r(e), r(i)) > a(r(s), r(o))
                      ? (h.important = "horizontal")
                      : (h.important = "vertical"),
                    n.using.call(this, t, h);
                }),
              u.offset(t.extend(T, { using: l }));
          })
        );
      }),
      (t.ui.position = {
  ...
  var d,
    p =
      (t.ui.autocomplete, "ui-button ui-widget ui-state-default ui-corner-all"),
    f =
      ...
      var n = function (t) {
        ...
        a =
          null == i || "" === i
            ...
            : new Date(i.getTime());
      return (
        (a = a && "Invalid Date" === a.toString() ? s : a),
        a &&
          (a.setHours(0),
          a.setMinutes(0),
          a.setSeconds(0),
        ...
        for (k = "", this.maxRows = 4, C = 0; C < U[1]; C++) {
          ...
          for (
            T +=
              ...
              I +
              "'>" +
              (/all|left/.test(I) && 0 === x ? (B ? o : s) : "") +
              (/all|right/.test(I) && 0 === x ? (B ? s : o) : "") +
          ...
          for (
            T += P + "</tr></thead><tbody>",
              ...
              z = (this._getFirstDayOfMonth(tt, Z) - u + 7) % 7,
              A = Math.ceil((z + S) / 7),
              H = X && this.maxRows > A ? this.maxRows : A,
              this.maxRows = H,
              N = this._daylightSavingAdjust(new Date(tt, Z, 1 - z)),
              E = 0;
            E < H;
            E++
          ) {
            for (
              ...
              (W = g ? g.apply(t.input ? t.input[0] : null, [N]) : [!0, ""]),
                (R = N.getMonth() !== Z),
                (F = (R && !_) || !W[0] || (Q && N < Q) || (J && N > J)),
                (O +=
                  "<td class='" +
                  ...
                  ((N.getTime() === D.getTime() &&
                    Z === t.selectedMonth &&
                    t._keyEvent) ||
                  (b.getTime() === N.getTime() && b.getTime() === D.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (F
  ...
  t.widget("ui.droppable", {
    ...
    (t.ui.intersect = (function () {
      ...
      return function (e, i, s, n) {
        ...
        switch (s) {
          case "fit":
            return l <= o && r <= c && u <= a && h <= d;
          case "intersect":
            return (
              l < o + e.helperProportions.width / 2 &&
              r - e.helperProportions.width / 2 < c &&
              u < a + e.helperProportions.height / 2 &&
          ...
          case "touch":
            return (
              ((a >= u && a <= d) || (h >= u && h <= d) || (a < u && h > d)) &&
              ((o >= l && o <= c) || (r >= l && r <= c) || (o < l && r > c))
            );
          default:
            return !1;
        }
  ...
  t.effects,
    ...
    (t.effects.effect.explode = function (e, i) {
      ...
      var o,
        ...
        b = [];
      for (o = 0; o < c; o++)
        for (h = g.top + o * _, u = o - (c - 1) / 2, a = 0; a < d; a++)
          (r = g.left + a * v),
            (l = a - (d - 1) / 2),
            p
              .clone()
    ...
    t.widget("ui.sortable", t.ui.mouse, {
      ...
      _intersectsWith: function (t) {
        var e = this.positionAbs.left,
          ...
          c = "x" === this.options.axis || (s + l > r && s + l < h),
      ...
      _refreshItems: function (e) {
        ...
        for (i = c.length - 1; i >= 0; i--)
          for (a = c[i][1], r = c[i][0], s = 0, l = r.length; s < l; s++)
            (h = t(r[s])),
    ...
    t.widget("ui.spinner", {
      ...
      _start: function (t) {
        return (
          !(!this.spinning && this._trigger("start", t) === !1) &&
      ...
      value: function (t) {
        return arguments.length
          ? void h(this._value).call(this, t)
    ...
    t.widget("ui.tabs", {
      ...
      _initialActive: function () {
        ...
        return (
          ...
          e !== !1 &&
            ((e = this.tabs.index(this.tabs.eq(e))), e === -1 && (e = !i && 0)),
...
runloop.colorForType = (function (t) {
  var e = [
    "#222",
    "#DB2C2C",
    "#F27900",
  ...
  return function (t) {
    return t < 0 || t >= e.length ? e[0] : e[t];
  };
})();
var runloop = window.runloop || {};
runloop.string = (function () {
  function t(t, e, i) {
    return (new Array(i + 1).join(e) + t).slice(-i);
  }
  function e(t, e, i) {
    return (t + new Array(i + 1).join(e)).slice(0, i);
  }
  function i(e) {
    var i;
    e = Math.floor(e);
  ...
  function s(t) {
    for (
      var e = [1, 60, 3600, 86400, 604800, 31536e3],
        i = t.split(":"),
        s = 0,
        n = i.length - 1,
        o = 0;
  ...
  return { lpad: t, rpad: e, fromDuration: i, toDuration: s };
})();
var runloop = window.runloop || {};
runloop.createClock = function () {
  function t() {
  ...
  var s;
  return e(), { reset: e, delta: i };
};
var runloop = window.runloop || {};
runloop.intervalsForDefinition = (function (t) {
  function e(t) {
    function e() {
      return (l = 0), h;
    }
  ...
  function i(t) {
    var i,
      ...
      a = 0,
      r = 0;
    for (s = 0; s < t.intervals.length; s++)
      t.intervals[s].rest !== !0 && (r += 1);
    for (s = 0; s < t.intervals.length; s++)
      t.intervals[s].rest !== !0 && (a += 1),
        (i = e(t.intervals[s])),
        (i.number = a + "/" + r),
        (n[o++] = i);
    return n;
  ...
  function s(t) {
    ...
    return (
      t.cooldown &&
        t.cooldown.duration > 0 &&
        ((i = e(t.cooldown)), (i.isRest = !0), (a[n++] = i)),
      a
    );
  }
  function n(t) {
    ...
    for (s = 0; s < t.numberOfSets; s++)
      s > 0 &&
        ((i = e(t.breaks)),
        (i.isRest = !0),
        (i.name = "End of Round " + s),
        (i.number = a + "/" + t.numberOfSets),
        (o[n++] = i)),
        (a += 1),
        (i = e(t.rounds)),
        (i.name = "Round " + (s + 1)),
  ...
  function o(t) {
    ...
    return (
      t.warmup &&
        t.warmup.duration > 0 &&
        ((interval = e(t.warmup)), (interval.isRest = !0), i.push(interval)),
      (i = t.group === !0 ? i.concat(a(t)) : i.concat(r(t))),
      t.cooldown &&
        t.cooldown.duration > 0 &&
        ((interval = e(t.cooldown)), (interval.isRest = !0), i.push(interval)),
      i
    );
  }
  function a(t) {
    var i,
      ...
      r = 0,
      h = 0;
    for (n = 0; n < t.intervals.length; n++)
      for (
        a = 0,
          r += 1,
          n > 0 && t.setRest.duration > 0
            ? ((i = e(t.setRest)),
              (i.name = "Rest"),
              (i.isRest = !0),
              (i.number =
                r + "-" + a + "/" + t.intervals.length + "-" + t.numberOfSets),
              (o[h++] = i))
            : n > 0 &&
              t.intervalRest.duration > 0 &&
              ((i = e(t.intervalRest)),
              (i.name = "Rest"),
              (i.isRest = !0),
              (i.number =
    ...
    for (s = 0; s < t.numberOfSets; s++)
      for (
        ...
        n > 0 &&
          ...
          (i.isRest = !0),
          (i.number =
            a + "-" + r + "/" + t.numberOfSets + "-" + t.intervals.length),
          (o[h++] = i)),
          (r += 1),
          (i = e(t.intervals[n])),
          (i.number =
  ...
  function h(t) {
    ...
    for (s = 0; s < t.numberOfSets; s++)
      for (
        s > 0 && t.circuitRest.duration > 0
          ? ((i = e(t.circuitRest)),
            (i.name = "Rest"),
            (i.isRest = !0),
            (r[h++] = i))
          : s > 0 &&
            t.timerRest.duration > 0 &&
            ((i = e(t.timerRest)),
            (i.name = "Rest"),
            (i.isRest = !0),
            (r[h++] = i)),
        ...
        for (
          ...
          r[h++] = a[o];
    for (s = 0; s < r.length; s++) r[s].isRest !== !0 && (l += 1);
    for (s = 0; s < r.length; s++)
      r[s].isRest !== !0 && (c += 1), (r[s].number = c + "/" + l);
    return r;
  }
  function l(t) {
    var i,
    ...
    return (
      t.cooldown &&
        t.cooldown.duration > 0 &&
        ((i = e(t.cooldown)), (i.isRest = !0), (o[h++] = i)),
      o
    );
  }
  function u(t) {
...
var runloop = window.runloop || {};
runloop.createTimer = function (t) {
  function e(t) {
    (v = t), i(0);
  }
  function i(t) {
  ...
  function a() {
    ...
    w += e;
    var i = Math.floor(w);
    t < i && m("update"), n() && n().passTime(e);
  }
  function r() {
    g || ((g = setInterval(a, 16)), y.reset(), m("start"));
  }
  function h() {
    g && (clearInterval(g), a(), (g = t), m("stop"));
  }
  function l() {
    i(0), h(), (w = 0), m("update");
  }
  ...
  function d() {
    for (var t = n().remaining(), e = x + 1; e < v.length; e++)
      t += v[e].duration;
    return t;
  }
  function p() {
    for (var t = 0, e = 0, i = 0; i < v.length; i++)
      v[i].rest || (i <= x && t++, e++);
    return t + " / " + e;
  }
  function f(t, e) {
...
!(function (t, e) {
  function i() {
    var t = $(".timer-main"),
      e = t.parent();
    t.css("top", e.height() * -0.22), t.css("font-size", 0.7 * e.height());
    var i = $(".timer-accessory");
    i.css("top", 0.55 * e.height()),
      i.css("padding-right", 0.03 * e.height()),
      i.css("padding-left", 0.03 * e.height()),
      i.find("h3").css("font-size", 0.045 * e.height()),
      i
        .find("p")
        .css("font-size", 0.1 * e.height())
        .css("top", e.height() * -0.02);
    var s = $(".timer li");
    s.css("font-size", 0.07 * e.height()),
      s.css("padding-top", 0.05 * e.height()),
      $(".timer-reset")
        .css("font-size", 0.07 * e.height())
        .css("padding-top", 0.06 * e.height()),
      $(".timer-start-toggle")
        .css("font-size", 0.07 * e.height())
        .css("padding-top", 0.06 * e.height());
  }
  $(t).resize(i), $(document).ready(i);
})(window);
var runloop = window.runloop || {};
!(function (t, e) {
  var i = runloop.string.fromDuration,
    s = runloop.intervalsForDefinition(def),
    n = $(".timer"),
    o = $(".timer ul"),
    a = $(".timer-start-toggle"),
    r = $(".timer-reset"),
    h = new Audio("https://www.intervaltimer.com/sounds/a6-sine-100ms.mp3"),
    l = new Audio("https://www.intervaltimer.com/sounds/a6-sine-750ms.mp3"),
    u = runloop
      .createTimer()
      .on("update", function () {
        $(".timer-elapsed p").text(i(u.elapsed())),
          $(".timer-remaining p").text(i(u.remaining() + 0.999)),
          $(".timer-main").text(i(u.interval().remaining() + 0.999));
      })
      .on("change", function () {
        $(".timer-interval-count p").text(u.intervalCount()),
          n.animate(
            { backgroundColor: runloop.colorForType(u.interval().color) },
            250
          ),
          o.animate({ left: -50 * u.currentIntervalIndex() + "%" });
      })
      .on("complete", function () {
        $(".timer-main").text(i(0)),
          $(".timer-remaining p").text(i(0)),
          n.animate({ backgroundColor: runloop.colorForType(0) }, 250),
          o.animate({ left: -50 * s.length + "%" });
      })
      .on("start", function () {
        a.find("span")
  ...
  u.setIntervals(s),
    ...
    a.click(function (t) {
      u.toggle(), t.stopPropagation();
    }),
    a.mousedown(function () {
      h.play();
    }),
    r.click(function (t) {
      u.reset(), t.stopPropagation();
    }),
  ...
  for (
    var d,
      p = function (t) {
        return function (e) {
          u.jump(t), u.start(), h.play(), e.stopPropagation();
        };
      },
      f = 0;
    f < s.length;
    ...
    (d = $("<li>" + s[f].name + "</li>")
      .css("background-color", runloop.colorForType(s[f].color))
      .css("width", 100 / (s.length + 1) + "%")),
      d.appendTo(o),
      d.click(p(f));
  (d = $("<li>End of Timer</li>")
    .css("background-color", runloop.colorForType(0))
    .css("width", 100 / (s.length + 1) + "%")),
    d.appendTo(o);
})(window);
